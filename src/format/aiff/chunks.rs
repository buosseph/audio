...
const NONE: (&'static [u8; 4], &'static [u8]) = (b"NONE",
                                                 b"not compressed");
const RAW : (&'static [u8; 4], &'static [u8]) = (b"raw ",
                                                 b"");
const ULAW: (&'static [u8; 4], &'static [u8]) = (b"ulaw",
                                                 b"\xB5law 2:1"); // µLaw 2:1
const ALAW: (&'static [u8; 4], &'static [u8]) = (b"alaw",
                                                 b"ALaw 2:1");
const FL32: (&'static [u8; 4], &'static [u8]) = (b"fl32",
                                                 b"IEEE 32-bit float");
const FL64: (&'static [u8; 4], &'static [u8]) = (b"fl64",
                                                 b"IEEE 64-bit float");
